...
export const PeoplePage = () => {
  ...
  if (isLoading) {
    return (
      <div className="people-page">
        <div className="people-page__loader" role="status" aria-live="polite">
  ...
  if (isError) {
    return (
      <div className="people-page">
        <div className="people-page__error" role="alert">
          ...
          <button
            ...
            className="people-page__retry-button"
          >
            Retry
          </button>
        </div>
  ...
  return (
    <div className="people-page">
      <div className="people-page__container">
        <h2 className="people-page__title">Star Wars Characters</h2>
        ...
        <div className="people-page__pagination">
          <button
            ...
            className="people-page__pagination-button"
            aria-label="Previous page"
          >
            ← Previous
          </button>
          <span className="people-page__pagination-info">

      ...
      <div className="modal" ref={modalRef} tabIndex={-1}>
        ...
        <div className="modal__content">
          ...
          <div className="modal__details">
            <h2 id="modal-title" className="modal__title">{person.name}</h2>
            
            <div className="modal__info">
              <div className="modal__info-item">
                <span className="modal__label">Height:</span>
              ...
              <div className="modal__info-item">
                <span className="modal__label">Mass:</span>
                <span className="modal__value">
              ...
              <div className="modal__info-item">
                <span className="modal__label">Birth Year:</span>
                <span className="modal__value">{person.birth_year}</span>
              </div>
              
              <div className="modal__info-item">
                <span className="modal__label">Films:</span>
                <span className="modal__value">{person.films.length}</span>
              </div>
              
              <div className="modal__info-item">
                <span className="modal__label">Date Added:</span>
                <span className="modal__value">{formatDate(person.created)}</span>
              </div>
            </div>

            <button
              className={`modal__favourite ${isFavourite ? 'modal__favourite--active' : ''}`}
